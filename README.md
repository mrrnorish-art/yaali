...
Download the last release of package from [Release page](https://github.com/flutter-v2ray/flutter_v2ray_mobile/releases/latest)

```yaml
dependencies:
  flutter_v2ray:
    path: <path of package directory>
```
